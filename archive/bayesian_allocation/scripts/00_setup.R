...
# ============================================================
# User-facing modal helpers (for Shiny UI)
# ============================================================

# Show a user-friendly modal dialog for errors.
#
# Reviewer request (JAS Reproducibility Specialist): provide graphical
# warnings (popup/modal) when uploads are malformed or other errors occur.
